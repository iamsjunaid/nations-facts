...
*Shows a list of countries along with the population of each country*<br>

*When clicked on it, shows the details of the selected country*
...
```sh
  cd my-folder
  git clone https://github.com/iamsjunaid/nations-facts.git
```
...
Feel free to check the [issues page](https://github.com/iamsjunaid/nations-facts/issues ).

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## ⭐️ Show your support <a name="support"></a>

If you like this project you can give a Star at project's [GitHub page](https://github.com/iamsjunaid/nations-facts).
...
This project is [MIT](https://github.com/iamsjunaid/nations-facts/blob/main/LICENSE) licensed.
